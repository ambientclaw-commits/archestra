 ...
 * None (no additional RBAC permission required)
 */
export const grantToolToAgent = <ThrowOnError extends boolean = false>(options: Options<GrantToolToAgentData, ThrowOnError>) => (options.client ?? client).post<GrantToolToAgentResponses, GrantToolToAgentErrors, ThrowOnError>({
