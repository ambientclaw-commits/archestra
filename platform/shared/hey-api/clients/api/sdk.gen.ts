...
/**
 * Get all smart routers for the organization
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const getLlmRouters = <ThrowOnError extends boolean = false>(options?: Options<GetLlmRoutersData, ThrowOnError>) => (options?.client ?? client).get<GetLlmRoutersResponses, GetLlmRoutersErrors, ThrowOnError>({ url: '/api/llm-routers', ...options });

/**
 * Create a smart router for the organization
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const createLlmRouter = <ThrowOnError extends boolean = false>(options: Options<CreateLlmRouterData, ThrowOnError>) => (options.client ?? client).post<CreateLlmRouterResponses, CreateLlmRouterErrors, ThrowOnError>({
    url: '/api/llm-routers',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const deleteLlmRouter = <ThrowOnError extends boolean = false>(options: Options<DeleteLlmRouterData, ThrowOnError>) => (options.client ?? client).delete<DeleteLlmRouterResponses, DeleteLlmRouterErrors, ThrowOnError>({ url: '/api/llm-routers/{id}', ...options });

/**
 * Get a smart router by ID
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `optimizationRule:read`: View optimization rules
 */
export const getLlmRouter = <ThrowOnError extends boolean = false>(options: Options<GetLlmRouterData, ThrowOnError>) => (options.client ?? client).get<GetLlmRouterResponses, GetLlmRouterErrors, ThrowOnError>({ url: '/api/llm-routers/{id}', ...options });
 ...
 */
export const updateLlmRouter = <ThrowOnError extends boolean = false>(options: Options<UpdateLlmRouterData, ThrowOnError>) => (options.client ?? client).put<UpdateLlmRouterResponses, UpdateLlmRouterErrors, ThrowOnError>({
    url: '/api/llm-routers/{id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
