...
/**
 * File generated by an agent and attached to an outbound email reply.
 */
export interface EmailResponseAttachment {
  ...
  contentBase64: string;
  /** Optional source artifact ID for logging/tracing */
  artifactId?: string;
}
...
export interface EmailReplyOptions {
  ...
  agentName?: string;
  /** Optional generated files to attach to the email reply */
  attachments?: EmailResponseAttachment[];
}
